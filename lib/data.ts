...
export const experienceTimeline = [
  {
    ...
    description: "Leading a team of 5 engineers building enterprise SaaS platforms. Architected micro-frontend systems and scaled APIs to 1M+ requests/day.",
  ...
  },
  {
    ...
    description: "Built premium marketing sites and web apps for Fortune 500 clients. Established design systems and component libraries.",
  ...
  },
  {
    ...
    role: "Web Developer",
    company: "StartUp Inc",
    description: "Full-stack development for early-stage products. Owned frontend architecture and CI/CD pipelines.",
...
export const projects = [
  ...
  },
  {
    ...
    title: "Aura Commerce",
    category: "E-Commerce",
    description: "Headless Shopify storefront with 3D product previews, AR try-on, and lightning-fast checkout.",
  ...
  },
  {
    ...
    title: "Orbit Social",
    category: "Social",
    description: "Real-time community platform with WebSocket feeds, collaborative docs, and gamified engagement.",
  ...
  },
  {
    ...
    title: "Zenith Health",
    category: "Healthcare",
    description: "Telemedicine app with HIPAA-compliant video calls, appointment scheduling, and EHR integration.",
  ...
  },
  {
    ...
    title: "Flux Finance",
    category: "Fintech",
    description: "Crypto portfolio tracker with real-time price feeds, yield farming calculators, and tax reporting.",
  ...
  },
  {
    ...
    title: "Voyage Travel",
    category: "Travel",
    description: "AI trip planner with dynamic itineraries, collaborative planning, and local experience bookings.",
...
export const projectCategories = ["All", "SaaS", "E-Commerce", "Social", "Healthcare", "Fintech", "Travel"];
...
export const blogCategories = ["All", "Engineering", "Design", "CSS", "Performance"];
